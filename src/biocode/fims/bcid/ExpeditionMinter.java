...
public class ExpeditionMinter {
    ...
    public Integer mint(
        ...
        try {
            ...
            Database.close(conn, insertStatement, null);
        }
        return expeditionId;
    }
    ...
    /**
     * Generate a Deep Links Format data for describing a set of root prefixes and associated concepts
     *
     * @param expeditionCode
     *
     * @return
    ...
    public JSONObject getDeepRoots(String expeditionCode, Integer projectId) {
        ...
        try {
            ...
            String sql =
                    "SELECT " +
                            ...
                            " e.expeditionCode = ? && \n" +
                            " e.projectId = ? && \n" +
                            "b.resourceType != \"http://purl.org/dc/dcmitype/Dataset\"";
            stmt = conn.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                data.put("identifier", rs.getString("identifier"));
                data.put("resourceType", rs.getString("resourceType"));
        ...
        metadata.put("expeditionTitle", expeditionTitle);
