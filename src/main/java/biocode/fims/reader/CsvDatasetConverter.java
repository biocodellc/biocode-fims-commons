...
public final class CsvDatasetConverter {
     ...
     */
    public CsvDatasetConverter(Dataset dataset, String outputDir, String filenamePrefix) {
    ...
    /**
     * converts the dataset samples to a csv file
     */
    public void convert(List<Attribute> attributes) {
        ...
        try {
            ...
            for (Object s : dataset.getSamples()) {
